...
export default function TopBar({ isPaused = false, isLobby = false, solidBg = false, teamName = 'Team Earth-1610', onTeamNameChange, currentScreen = 'coding', onNavigate, hintStage = 0, contestEndsAt = null, teamFrozenUntil = null, }) {
    ...
    useEffect(() => {
        if (isPaused || isTimerFrozen || seconds <= 0)
            return;
        const interval = setInterval(() => {
